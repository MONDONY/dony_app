...
void main() {
  ...
  testWidgets('shows delivered bids list', (tester) async {
    when(() => bloc.state).thenReturn(BidListLoaded([
      _bid(id: 'b1', status: 'DELIVERED', travelerName: 'Mamadou Diallo'),
  ...
  testWidgets('shows fully populated delivered bid card', (tester) async {
