...
Widget _wrap(MockWalletBloc bloc) {
      ...
      routerConfig: GoRouter(
        ...
        routes: [
          GoRoute(
            path: '/',
            builder: (_, _) =>
                const Scaffold(body: WalletBalanceCard()),
          ),
          GoRoute(
            path: '/payments/wallet',
            builder: (_, _) => const Scaffold(body: Text('WalletScreen')),
          ),
          GoRoute(
            path: '/payments/wallet/topup/method',
            builder: (_, _) =>
                const Scaffold(body: Text('TopupMethodScreen')),
          ),
        ],
      ),
    ),
