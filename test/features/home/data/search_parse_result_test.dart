...
void main() {
  ...
  group('applyTo', () {
    ...
    test('pose chaque champ reconnu sur son homologue Flutter exact '
    ...
    test(
      'un transportMode inconnu du serveur est ignoré plutôt que de faire '
    ...
    test(
      'applyTo ne dépend pas du mode : le serveur ne renvoie maxWeight que '
