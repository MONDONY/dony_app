...
void main() {
  ...
  test('disputeTypeLabel garde le comportement existant (contestation d\'absence + fallback)', () {
    expect(disputeTypeLabel('SENDER_NO_SHOW_CONTESTED'), "Contestation d'absence");
