...
void main() {
  ...
  group('submit', () {
    blocTest<IncidentReportCubit, IncidentReportState>(
      ...
      expect: () => [
        ...
        isA<IncidentReportSuccess>()
            .having((s) => s.reportId, 'reportId', 'r-7'),
      ],
    );
    ...
    blocTest<IncidentReportCubit, IncidentReportState>(
      ...
      expect: () => [
        ...
        isA<IncidentReportError>()
            .having((s) => s.message, 'message', 'Le motif est obligatoire'),
      ],
    );
    ...
    blocTest<IncidentReportCubit, IncidentReportState>(
      ...
      act: (cubit) async {
        unawaited(cubit.submit(targetType: IncidentTargetType.app, reason: 'Autre'));
