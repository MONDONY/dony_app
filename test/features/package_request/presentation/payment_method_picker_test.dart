...
typedef _MyTripsResult = ({List<AnnouncementModel> announcements, int totalElements});

_MyTripsResult _emptyTrips() => (announcements: const <AnnouncementModel>[], totalElements: 0);
...
Future<void> _pump(WidgetTester tester,
    ...
    Set<PaymentMethod> methods = const {
...
void main() {
  setUpAll(() async {
    ...
    registerFallbackValue(const NegotiationSubmitTripRequested(
      threadId: '',
  ...
  testWidgets(
    ...
    when(() => announcementRepo.getMyAnnouncements()).thenAnswer(
        (_) async => (announcements: [trip], totalElements: 1));
    ...
    verify(() => negotiationBloc.add(any(
