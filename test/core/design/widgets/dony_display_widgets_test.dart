...
void main() {
  ...
  group('DonyTripCard', () {
    ...
    testWidgets('renders traveler name', (tester) async {
      await tester.pumpWidget(_wrap(const DonyTripCard(
    ...
    testWidgets('onTap callback fires on tap', (tester) async {
      var tapped = false;
      await tester.pumpWidget(_wrap(DonyTripCard(
    ...
    testWidgets('all optional params provided at once', (tester) async {
      ...
      expect(tapCount, greaterThanOrEqualTo(0)); // tap verified via callback coverage
    });
  });
  ...
  group('DonyListTile', () {
    testWidgets('renders label text', (tester) async {
      await tester.pumpWidget(_wrap(const DonyListTile(label: 'Notifications')));
      await tester.pump();
      expect(find.text('Notifications'), findsOneWidget);
    });

    testWidgets('renders subtitle when provided', (tester) async {
      await tester.pumpWidget(_wrap(const DonyListTile(
        label: 'Langue',
        subtitle: 'Français',
      )));
      await tester.pump();
    ...
    testWidgets('onTap callback fires', (tester) async {
      var tapped = false;
      await tester.pumpWidget(_wrap(DonyListTile(
        label: 'Tappable',
        onTap: () => tapped = true,
      )));
      await tester.pump();
    ...
    testWidgets('shows chevron when onTap provided and no trailing', (tester) async {
      await tester.pumpWidget(_wrap(DonyListTile(
        label: 'With chevron',
        onTap: () {},
      )));
    ...
    testWidgets('destructive=true changes label color to error', (tester) async {
      await tester.pumpWidget(_wrap(const DonyListTile(
    ...
    testWidgets('destructive=true with icon uses error color for icon', (tester) async {
      await tester.pumpWidget(_wrap(const DonyListTile(
        label: 'Delete',
  ...
  group('DonyListSection', () {
    testWidgets('renders section title in uppercase', (tester) async {
      await tester.pumpWidget(_wrap(const DonyListSection(
        title: 'compte',
        tiles: [
    ...
    testWidgets('tile callbacks are forwarded correctly', (tester) async {
      var tapped = false;
      await tester.pumpWidget(_wrap(DonyListSection(
        title: 'Actions',
        tiles: [
          DonyListTile(label: 'Tap me', onTap: () => tapped = true),
        ],
      )));
      await tester.pump();
      await tester.tap(find.byType(InkWell));
    ...
    testWidgets('tiles with all props are forwarded by DonyListSection', (tester) async {
      await tester.pumpWidget(_wrap(const DonyListSection(
        title: 'Paramètres',
        tiles: [
          DonyListTile(
  ...
  group('DonyUserCard', () {
    testWidgets('renders name', (tester) async {
      await tester.pumpWidget(_wrap(const DonyUserCard(name: 'Ibrahima Diallo')));
      await tester.pump();
      expect(find.text('Ibrahima Diallo'), findsOneWidget);
    });

    testWidgets('renders subtitle when provided', (tester) async {
      await tester.pumpWidget(_wrap(const DonyUserCard(
        name: 'Amadou',
    ...
    testWidgets('shows rating and star icon when rating provided', (tester) async {
      await tester.pumpWidget(_wrap(const DonyUserCard(
        name: 'Fatoumata',
        rating: 4.8,
      )));
    ...
    testWidgets('onTap callback fires', (tester) async {
      var tapped = false;
      await tester.pumpWidget(_wrap(DonyUserCard(
        name: 'Tap User',
        onTap: () => tapped = true,
      )));
      await tester.pump();
    ...
    testWidgets('compact=false uses base padding and titleLarge style', (tester) async {
      await tester.pumpWidget(_wrap(const DonyUserCard(
        name: 'Full User',
  ...
  group('DonySectionHeader', () {
    testWidgets('renders title', (tester) async {
      await tester.pumpWidget(_wrap(const DonySectionHeader(title: 'Trajets récents')));
      await tester.pump();
      expect(find.text('Trajets récents'), findsOneWidget);
    });

    testWidgets('renders subtitle when provided', (tester) async {
      await tester.pumpWidget(_wrap(const DonySectionHeader(
        title: 'Mes trajets',
    ...
    testWidgets('shows action button when actionLabel and onAction provided', (tester) async {
      await tester.pumpWidget(_wrap(DonySectionHeader(
        title: 'Annonces',
    ...
    testWidgets('shows arrow_forward_rounded icon in action button', (tester) async {
      await tester.pumpWidget(_wrap(DonySectionHeader(
        title: 'Trajets',
        actionLabel: 'Plus',
        onAction: () {},
    ...
    testWidgets('uses CrossAxisAlignment.center when no subtitle', (tester) async {
    ...
    testWidgets('uses CrossAxisAlignment.start when subtitle present', (tester) async {
      await tester.pumpWidget(_wrap(DonySectionHeader(
        title: 'With subtitle',
        subtitle: 'A subtitle',
        actionLabel: 'Voir',
    ...
    testWidgets('uses zero padding by default', (tester) async {
      await tester.pumpWidget(_wrap(const DonySectionHeader(title: 'Default pad')));
      await tester.pump();
