...
void main() {
  group('DonySelectBar', () {
    ...
    testWidgets(
      ...
      (tester) async {
        await tester.pumpWidget(
          _wrap(
            const DonySelectBar(defaultLabel: 'Sélectionner', onConfirm: null),
          ),
        );
    ...
    testWidgets('nothing selected — confirmedLabel is not shown', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('isLoading: false (default) — no spinner shown', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
