...
void main() {
  group('DonyButton', () {
    ...
    testWidgets('primary variant renders InkWell (gradient button)', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(DonyButton(label: 'Test', onPressed: () {})),
      );
    ...
    testWidgets('destructive variant renders InkWell (gradient button)', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('success variant renders InkWell (gradient button)', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('primary dark mode renders InkWell', (tester) async {
      await tester.pumpWidget(
        _wrapDark(DonyButton(label: 'Dark', onPressed: () {})),
      );
    ...
    testWidgets('disabled primary: InkWell.onTap is null', (tester) async {
      await tester.pumpWidget(
        _wrap(const DonyButton(label: 'Test', onPressed: null)),
      );
    ...
    testWidgets('disabled secondary: OutlinedButton.onPressed is null', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('shows leading icon when provided', (tester) async {
      await tester.pumpWidget(
        _wrap(DonyButton(label: 'Test', onPressed: () {}, icon: Icons.send)),
      );
    ...
    testWidgets('is full width by default', (tester) async {
      await tester.pumpWidget(
        _wrap(DonyButton(label: 'Full', onPressed: () {})),
      );
    ...
    testWidgets('fullWidth false sets compact size', (tester) async {
      await tester.pumpWidget(
        _wrap(DonyButton(label: 'Compact', onPressed: () {}, fullWidth: false)),
      );
      final btn = tester.widget<DonyButton>(find.byType(DonyButton));
    ...
    testWidgets('tap triggers onPressed callback', (tester) async {
      var tapped = false;
      await tester.pumpWidget(
        _wrap(DonyButton(label: 'Tap', onPressed: () => tapped = true)),
      );
    ...
    testWidgets('isLoading shows CircularProgressIndicator (primary)', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(DonyButton(label: 'Loading', onPressed: () {}, isLoading: true)),
      );
      final inkWell = tester.widget<InkWell>(
        _inkWellIn(find.byType(DonyButton)),
      );
    ...
    testWidgets(
      'DonyButtonVariant.accent renders with terracotta gradient background',
      (tester) async {
        await tester.pumpWidget(
          _wrap(
            DonyButton(
