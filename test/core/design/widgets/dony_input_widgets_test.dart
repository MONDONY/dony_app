...
void main() {
  ...
  group('DonyChip', () {
    ...
    testWidgets('opacity is 1.0 when enabled', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyChip(label: 'Enable', selected: false, onTap: () {}),
      ));
    ...
    testWidgets('selected chip renders with bold weight (selected=true)', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyChip(label: 'Selected', selected: true, onTap: () {}),
      ));
      await tester.pump(const Duration(milliseconds: 600));
      expect(find.text('Selected'), findsOneWidget);
    });

    testWidgets('unselected chip renders normally (selected=false)', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyChip(label: 'Unselected', selected: false, onTap: () {}),
      ));
      await tester.pump(const Duration(milliseconds: 600));
    ...
    testWidgets('AnimatedContainer is present in widget tree', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyChip(label: 'Anim', selected: false, onTap: () {}),
      ));
  ...
  group('DonyChipGroup<String>', () {
    ...
    testWidgets('single-select: tapping an option calls onChanged with that item only',
        (tester) async {
      Set<String> result = {};
      await tester.pumpWidget(_wrap(
        StatefulBuilder(
    ...
    testWidgets('multi-select: tapping adds items to selection', (tester) async {
      Set<String> result = {};
      await tester.pumpWidget(_wrap(
        StatefulBuilder(
          builder: (context, setState) => DonyChipGroup<String>(
    ...
    testWidgets('multi-select: tapping selected item removes it', (tester) async {
    ...
    testWidgets('iconBuilder is called and renders icon when non-null', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyChipGroup<String>(
          options: const ['Avion'],
          labelBuilder: (v) => v,
  ...
  group('DonyCheckbox', () {
    ...
    testWidgets('does not render subtitle when absent', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyCheckbox(label: 'Label', value: false, onChanged: (_) {}),
      ));
    ...
    testWidgets('tristate=false: tapping cycles false -> true (not null)', (tester) async {
      bool? received;
      await tester.pumpWidget(_wrap(
        DonyCheckbox(
          label: 'Tristate off',
    ...
    testWidgets('CrossAxisAlignment is start when subtitle provided', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyCheckbox(
          label: 'Label',
          value: false,
    ...
    testWidgets('CrossAxisAlignment is center when no subtitle', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyCheckbox(label: 'Label', value: false, onChanged: (_) {}),
      ));
      final row = tester.widget<Row>(find.byType(Row).first);
  ...
  group('DonyRadioGroup<String>', () {
    ...
    testWidgets('tapping an option fires onChanged with that value', (tester) async {
      String? selected;
      await tester.pumpWidget(_wrap(
        DonyRadioGroup<String>(
          options: options,
    ...
    testWidgets('vertical direction uses Column layout (default)', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyRadioGroup<String>(
          options: options,
          value: null,
    ...
    testWidgets('disabled option: tapping does not fire onChanged', (tester) async {
      bool called = false;
    ...
    testWidgets('selected value changes _RadioDot appearance (selected=true path)',
        (tester) async {
      await tester.pumpWidget(_wrap(
        DonyRadioGroup<String>(
          options: options,
    ...
    testWidgets('CrossAxisAlignment is start for option with subtitle', (tester) async {
      await tester.pumpWidget(_wrap(
        DonyRadioGroup<String>(
          options: options,
          value: null,
  ...
  group('DonySearchField', () {
    testWidgets('renders hint text', (tester) async {
      await tester.pumpWidget(_wrap(
        const DonySearchField(hint: 'Rechercher un trajet...'),
      ));
    ...
    testWidgets('renders custom prefix icon when provided', (tester) async {
      await tester.pumpWidget(_wrap(
        const DonySearchField(prefixIcon: Icons.location_on),
      ));
    ...
    testWidgets('onChanged fires when text is entered', (tester) async {
      String? received;
      await tester.pumpWidget(_wrap(
        DonySearchField(onChanged: (v) => received = v),
      ));
    ...
    testWidgets('onSubmitted fires on keyboard submit', (tester) async {
      String? submitted;
      await tester.pumpWidget(_wrap(
        DonySearchField(onSubmitted: (v) => submitted = v),
      ));
    ...
    testWidgets('onClear fires when clear button is tapped', (tester) async {
      bool cleared = false;
      await tester.pumpWidget(_wrap(
        DonySearchField(onClear: () => cleared = true),
      ));
    ...
    testWidgets('onChanged fires with empty string when clear button is tapped',
        (tester) async {
      String? lastValue = 'sentinel';
      await tester.pumpWidget(_wrap(
        DonySearchField(onChanged: (v) => lastValue = v),
      ));
    ...
    testWidgets('accepts external controller and reflects its value', (tester) async {
      final controller = TextEditingController();
      addTearDown(controller.dispose);
      await tester.pumpWidget(_wrap(
        DonySearchField(controller: controller),
      ));
    ...
    testWidgets('enabled=false disables the TextField', (tester) async {
      await tester.pumpWidget(_wrap(
        const DonySearchField(enabled: false),
      ));
      final tf = tester.widget<TextField>(find.byType(TextField));
    ...
    testWidgets('autofocus=true passes autofocus to TextField', (tester) async {
      await tester.pumpWidget(_wrap(
        const DonySearchField(autofocus: true),
      ));
      final tf = tester.widget<TextField>(find.byType(TextField));
