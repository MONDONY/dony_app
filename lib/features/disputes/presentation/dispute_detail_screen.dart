  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(l.disputeDetailTitle),
      ),
        ...
        child:
            Column(
                  ...
                  children: [
                          ...
                          Text(
                            [
                              if (d.otherPartyName != null)
                                l.disputeOtherParty(d.myRole, d.otherPartyName!)
                              else
                                l.disputeShipmentDeleted,
                              if (d.weightKg != null)
                                l.disputeParcelWeight(
                                  disputeWeightLabel(l, d.weightKg!),
                                ),
                            ].join(' · '),
                    ...
                    Text(
                      l.disputeDetailTimelineSectionTitle,
                    ...
                    if (d.isResolved) ...[
                      const SizedBox(height: 20),
                      Text(
                        l.disputeDetailDecisionSectionTitle,
                        style: tt.labelSmall?.copyWith(
                          color: cs.onSurfaceVariant,
                          fontWeight: FontWeight.w700,
                          letterSpacing: 1.1,
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    d.isBeneficiary
                                        ? l.disputeDetailResolvedInFavor
                                        : l.disputeDetailResolved,
                                    style: tt.titleSmall?.copyWith(
                                  ...
                                  if (showAmount) ...[
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          l.disputeDetailCompensationPaid,
                                          style: tt.bodyMedium,
                                        ),
                                        Text(
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: Text(l.disputeDetailContactSupport),
                      ),
                    ),
                  ],
                )
