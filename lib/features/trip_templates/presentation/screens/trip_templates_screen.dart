        ...
        children: [
          const Padding(
            ...
            child: ContextualTutorialCard(
              context: TutorialContext.tripTemplates,
            ),
          ),
          Expanded(
            child: BlocBuilder<TripTemplateBloc, TripTemplateState>(
              builder: (context, state) {
                if (state.status == TripTemplateStatus.loading &&
                ...
                if (state.status == TripTemplateStatus.error &&
                    state.templates.isEmpty) {
        ...
        switch (action) {
          ...
          case _TemplateAction.delete:
            ...
            if ((confirmed ?? false) && context.mounted) {
              context.read<TripTemplateBloc>().add(
                TripTemplateDeleted(template.id),
              );
            }
        }
      },
