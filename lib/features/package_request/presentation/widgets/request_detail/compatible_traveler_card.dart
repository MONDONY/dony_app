...
class CompatibleTravelerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final freeShare = total > 0
        ...
        : 0.0;
    final needShare = total > 0
        ? (requestWeightKg / total).clamp(0.0, freeShare)
        : 0.0;
              ...
              Row(
                children: [
                  DonyAvatar(
                    ...
                    verified: trip.traveler?.kycVerified ?? false,
                  ),
                  ...
                  child: Stack(
                    children: [
                      ...
                      FractionallySizedBox(
                        widthFactor: freeShare,
                        child: Container(color: cs.primary),
                      ),
                      FractionallySizedBox(
                        widthFactor: needShare,
                        child: Container(color: cs.success),
                      ),
                    ],
                  ),
                ),
