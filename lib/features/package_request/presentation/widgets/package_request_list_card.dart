                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    '${item.contentCategory.label} · $_sizeLabel',
...
class _RouteMeta extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tol = item.dateToleranceDays > 0 ? ' ±${item.dateToleranceDays}j' : '';
    final parts = <String>[
      ?depFlag,
      item.departureCity,
      '→',
...
class _Thumbnail extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final url = item.photoUrls.isNotEmpty ? item.photoUrls.first : item.photoUrl;
